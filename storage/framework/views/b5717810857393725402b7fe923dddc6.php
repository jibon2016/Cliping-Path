    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form enctype="multipart/form-data" id="slider-form" action="<?php echo e(route('slider.store')); ?>" class="form-horizontal" method="post">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="<?php echo e(old('sub_title')); ?>" name="sub_title" class="form-control" id="sub_title" placeholder="Enter Sub Title">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="<?php echo e(old('link')); ?>" name="link" class="form-control" id="link" placeholder="Enter Link">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Image Attachment <span class="text-danger">*</span> </label>
                            <div class="col-sm-10">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PHP-8.2.4\htdocs\surjeralo\resources\views/backend/slider/create.blade.php ENDPATH**/ ?>