<?php $__env->startSection('title','Executive Committee Create'); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form enctype="multipart/form-data" id="customer-form" action="<?php echo e(route('executive-committees.store')); ?>" class="form-horizontal" method="post">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="<?php echo e(old('designation')); ?>" name="designation" class="form-control" id="designation" placeholder="Enter Designation">
                                <span id="designation-error" class="help-block error-message"></span>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="designation" class="col-sm-2 col-form-label">Education</label>
                            <div class="col-sm-10">
                                <input type="text" value="<?php echo e(old('education')); ?>" name="education" class="form-control" id="education" placeholder="Enter Education">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PHP-8.2.4\htdocs\surjeralo\resources\views/backend/executive_committee/create.blade.php ENDPATH**/ ?>