                ...
                <form id="company-information-form" enctype="multipart/form-data" action="<?php echo e(route('company-information.update',['company_information'=>$company_information->id])); ?>" class="form-horizontal" method="post">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="background" class="col-sm-12">Background <span class="text-danger">*</span></label>
                            <div class="col-sm-12">
                                <textarea name="background" class="form-control" id="background"><?php echo e(old('background',$company_information->background)); ?></textarea>
                                <span id="background-error" class="text-danger error-message"></span>
                            </div>
                        </div>
                    </div>
                    <!-- /.card-body -->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PHP-8.2.4\htdocs\surjeralo\resources\views/backend/about_us/background.blade.php ENDPATH**/ ?>