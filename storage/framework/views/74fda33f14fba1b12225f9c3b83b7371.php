<?php $__env->startSection('title','Organogram'); ?>
        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Organogram Information</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form id="company-information-form" enctype="multipart/form-data" action="<?php echo e(route('company-information.update',['company_information'=>$company_information->id])); ?>" class="form-horizontal" method="post">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="organogram" class="col-sm-12">Organogram <span class="text-danger">*</span></label>
                            <div class="col-sm-12">
                                <textarea name="organogram" class="form-control" id="organogram"><?php echo e(old('organogram',$company_information->organogram)); ?></textarea>
                                <span id="organogram-error" class="text-danger error-message"></span>
                            </div>
                        </div>
                    </div>
                    <!-- /.card-body -->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PHP-8.2.4\htdocs\surjeralo\resources\views/backend/about_us/organogram.blade.php ENDPATH**/ ?>