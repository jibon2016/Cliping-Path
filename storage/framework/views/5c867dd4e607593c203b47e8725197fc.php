<?php $__env->startSection('title','Activity Edit'); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form id="news-form" enctype="multipart/form-data" action="<?php echo e(route('activity.update',['activity'=>$activity->id])); ?>" class="form-horizontal" method="post">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body">
                                    ...
                                    <div class="col-sm-12">
                                        <select name="category" id="category" class="form-control select2">
                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php echo e(old('category',$activity->activity_category_id) == $category->id ? 'selected' : ''); ?> value="<?php echo e($category->id); ?>">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" value="<?php echo e(old('title',$activity->title)); ?>" name="title" class="form-control" id="title" placeholder="Enter Title">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <textarea name="short_description" class="form-control" id="short_description"><?php echo e(old('short_description',$activity->short_description)); ?></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <textarea name="description" id="description"><?php echo e(old('description',$activity->description)); ?></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <div class="icheck-success d-inline pull-right">
                                    <input  type="radio" id="active" name="status" value="1" <?php echo e(old('status',$activity->status) == '1' ? 'checked' : ''); ?>>
                                    <label for="active">
                                        Active
                                    </label>
                                </div>
                                <div class="icheck-danger d-inline pull-right">
                                    <input type="radio" id="inactive" name="status" value="0" <?php echo e(old('status',$activity->status) == '0' ? 'checked' : ''); ?>>
                                    <label for="inactive">
                                        Inactive
                                    </label>
                                </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="<?php echo e(route('activity.index')); ?>" class="btn btn-danger bg-gradient-danger btn-sm float-right">Cancel</a>
                    </div>
                    <!-- /.card-footer -->
                </form>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PHP-8.2.4\htdocs\surjeralo\resources\views/backend/activity/edit.blade.php ENDPATH**/ ?>