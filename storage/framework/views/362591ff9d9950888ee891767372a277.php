<?php $__env->startSection('title','Executive Committee Organogram'); ?>
        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Executive Committee Organogram Information</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form id="company-information-form" enctype="multipart/form-data" action="<?php echo e(route('company-information.update',['company_information'=>$company_information->id])); ?>" class="form-horizontal" method="post">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="executive_committee_organigram" class="col-sm-12">Executive Committee Organigram <span class="text-danger">*</span></label>
                            <div class="col-sm-12">
                                <textarea name="executive_committee_organigram" class="form-control" id="executive_committee_organigram"><?php echo e(old('executive_committee_organigram',$company_information->executive_committee_organigram)); ?></textarea>
                                <span id="executive_committee_organigram-error" class="text-danger error-message"></span>
                            </div>
                        </div>
                    </div>
                    <!-- /.card-body -->
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        // Summernote
        $('#executive_committee_organigram').summernote({
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PHP-8.2.4\htdocs\surjeralo\resources\views/backend/about_us/executive_committee_organogram.blade.php ENDPATH**/ ?>