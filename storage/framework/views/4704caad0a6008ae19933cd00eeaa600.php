<?php $__env->startSection('title','Vision'); ?>
        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Vision Information</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PHP-8.2.4\htdocs\surjeralo\resources\views/backend/about_us/vision.blade.php ENDPATH**/ ?>