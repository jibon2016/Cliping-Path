<?php $__env->startSection('title','Working Area'); ?>
                ...
                <form id="company-information-form" enctype="multipart/form-data" action="<?php echo e(route('company-information.update',['company_information'=>$company_information->id])); ?>" class="form-horizontal" method="post">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <textarea name="working_area" class="form-control" id="working_area"><?php echo e(old('working_area',$company_information->working_area)); ?></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PHP-8.2.4\htdocs\surjeralo\resources\views/backend/about_us/work_area.blade.php ENDPATH**/ ?>