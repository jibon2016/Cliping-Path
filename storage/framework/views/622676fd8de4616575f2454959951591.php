<?php $__env->startSection('title','Activity Create'); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form enctype="multipart/form-data" id="news-form" action="<?php echo e(route('activity.store')); ?>" class="form-horizontal" method="post">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="col-sm-12">
                                        <select name="category" id="category" class="form-control select2">
                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php echo e(old('category') == $category->id ? 'selected' : ''); ?> value="<?php echo e($category->id); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <textarea name="short_description" class="form-control" id="short_description"><?php echo e(old('short_description')); ?></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PHP-8.2.4\htdocs\surjeralo\resources\views/backend/activity/create.blade.php ENDPATH**/ ?>