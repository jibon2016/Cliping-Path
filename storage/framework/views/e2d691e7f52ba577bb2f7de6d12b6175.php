        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Company Information Information</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form id="company-information-form" enctype="multipart/form-data" action="<?php echo e(route('company-information.update',['company_information'=>$company_information->id])); ?>" class="form-horizontal" method="post">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="company_profile" class="col-sm-12">Company Profile <span class="text-danger">*</span></label>
                            <div class="col-sm-12">
                                <textarea name="company_profile" class="form-control" id="company_profile"><?php echo e(old('company_profile',$company_information->company_profile)); ?></textarea>
                                <span id="company_profile-error" class="text-danger error-message"></span>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="vision" class="col-sm-12">Vision <span class="text-danger">*</span></label>
                            <div class="col-sm-12">
                                <textarea name="vision" class="form-control" id="vision"><?php echo e(old('vision',$company_information->vision)); ?></textarea>
                                <span id="vision-error" class="text-danger error-message"></span>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="mission" class="col-sm-12">Mission <span class="text-danger">*</span></label>
                            <div class="col-sm-12">
                                <textarea name="mission" class="form-control" id="mission"><?php echo e(old('mission',$company_information->mission)); ?></textarea>
                                <span id="mission-error" class="text-danger error-message"></span>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PHP-8.2.4\htdocs\surjeralo\resources\views/backend/company_information/edit.blade.php ENDPATH**/ ?>