<?php $__env->startSection('title','Success Story Edit'); ?>
        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Success Story Information</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form id="news-form" enctype="multipart/form-data" action="<?php echo e(route('story.update',['story'=>$story->id])); ?>" class="form-horizontal" method="post">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" value="<?php echo e(old('title',$story->title)); ?>" name="title" class="form-control" id="title" placeholder="Enter Title">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <textarea name="short_description" class="form-control" id="short_description"><?php echo e(old('short_description',$story->short_description)); ?></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <textarea name="description" id="description"><?php echo e(old('description',$story->description)); ?></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <div class="icheck-success d-inline pull-right">
                                    <input  type="radio" id="active" name="status" value="1" <?php echo e(old('status',$story->status) == '1' ? 'checked' : ''); ?>>
                                    <label for="active">
                                        Active
                                    </label>
                                </div>
                                <div class="icheck-danger d-inline pull-right">
                                    <input type="radio" id="inactive" name="status" value="0" <?php echo e(old('status',$story->status) == '0' ? 'checked' : ''); ?>>
                                    <label for="inactive">
                                        Inactive
                                    </label>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div id="file-previews" class="file-preview row">
                                    <?php $__currentLoopData = $story->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        <div class="wrapper-list-item">
                                            <input type="number" value="<?php echo e($attachment->sort); ?>" placeholder="Sort" class="file-title-input old-file-sort-update">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="<?php echo e(route('story.index')); ?>" class="btn btn-danger bg-gradient-danger btn-sm float-right">Cancel</a>
                    </div>
                    <!-- /.card-footer -->
                </form>
            </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        $('body').on('focusout', '.old-file-sort-update', function() {
            ...
            $.ajax({
                method: "post",
                url: "<?php echo e(route('attachment-sort-update')); ?>",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PHP-8.2.4\htdocs\surjeralo\resources\views/backend/story/edit.blade.php ENDPATH**/ ?>