...
<?php $__env->startSection('content'); ?>
    <section class="full-height vertical-center position-relative overflow-hidden">
        <video autoplay muted loop playsinline class="bg-video">
            <source src="<?php echo e(asset('uploads/video/free.mp4')); ?>" type="video/mp4">
            ...
            <div class="row">
                <div class="col-12 text-center text-white">
                    ...
                    <div class="local-scroll wow fadeInUp wch-unset" data-wow-delay="0.5s" data-wow-duration="1.2s">
                        <a href="<?php echo e(route('home')); ?>" class="btn btn-mod btn-color btn-small btn-circle btn-hover-animX me-1 mb-xs-10">
                                ...
                                <div class="solution borderx rounded position-relative px-2 py-3">
                                    ...
                                    <div class="preview_image custom_animation">
                                        ...
                                        <div class="container1" class='twentytwenty-container'>
                                            <img src="<?php echo e(asset('themes\frontend\assets\images\work\after.png')); ?>" alt="jn">
                                            <img src="<?php echo e(asset('themes\frontend\assets\images\work\before.png')); ?>" alt="jn">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="col-3">
                                                <!-- Circular Image -->
                                                <img loading="lazy" src="<?php echo e(asset('themes\frontend\assets\images\work\sm_thumb.png')); ?>" class="ImageProfile" alt="Profile Image">
                                                <span class="tick">
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\photopixelqa\resources\views/frontend/home.blade.php ENDPATH**/ ?>