<?php $__env->startSection('title','About Us Information'); ?>
                ...
                <form id="company-information-form" enctype="multipart/form-data" action="<?php echo e(route('company-information.update',['company_information'=>$company_information->id])); ?>" class="form-horizontal" method="post">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="company_profile" class="col-sm-12">About Us <span class="text-danger">*</span></label>
                            <div class="col-sm-12">
                                <textarea name="about_us" class="form-control" id="about_us"><?php echo e(old('about_us',$company_information->about_us)); ?></textarea>
                                <span id="about_us-error" class="text-danger error-message"></span>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PHP-8.2.4\htdocs\surjeralo\resources\views/backend/about_us/about_us.blade.php ENDPATH**/ ?>