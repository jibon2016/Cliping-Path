<?php $__env->startSection('title',$category->name.'  Edit'); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form id="news-form" enctype="multipart/form-data" action="<?php echo e(route('programs.update',['program'=>$program->id,'category_program'=>$category->id])); ?>" class="form-horizontal" method="post">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" value="<?php echo e(old('title',$program->title)); ?>" name="title" class="form-control" id="title" placeholder="Enter Title">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="number" value="<?php echo e(old('sort',$program->sort)); ?>" name="sort" class="form-control" id="sort" placeholder="Enter Sort">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <textarea name="description" id="description"><?php echo e(old('description',$program->description)); ?></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <div class="icheck-success d-inline pull-right">
                                    <input  type="radio" id="active" name="status" value="1" <?php echo e(old('status',$program->status) == '1' ? 'checked' : ''); ?>>
                                    <label for="active">
                                        Active
                                    </label>
                                </div>
                                <div class="icheck-danger d-inline pull-right">
                                    <input type="radio" id="inactive" name="status" value="0" <?php echo e(old('status',$program->status) == '0' ? 'checked' : ''); ?>>
                                    <label for="inactive">
                                        Inactive
                                    </label>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PHP-8.2.4\htdocs\surjeralo\resources\views/backend/program/edit.blade.php ENDPATH**/ ?>