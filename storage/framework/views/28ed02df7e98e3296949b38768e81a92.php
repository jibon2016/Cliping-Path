<?php $__env->startSection('title','ActivityCategory Edit'); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form id="category-form" enctype="multipart/form-data" action="<?php echo e(route('activity-category.update',['activity_category'=>$activity_category->id])); ?>" class="form-horizontal" method="post">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="<?php echo e(old('name',$activity_category->name)); ?>" name="name" class="form-control" id="name" placeholder="Enter Name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" value="<?php echo e(old('sort',$activity_category->sort)); ?>" name="sort" class="form-control" id="sort" placeholder="Enter Sort">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="icheck-success d-inline pull-right">
                                    <input  type="radio" id="active" name="status" value="1" <?php echo e(old('status',$activity_category->status) == '1' ? 'checked' : ''); ?>>
                                    <label for="active">
                                        Active
                                    </label>
                                </div>
                                <div class="icheck-danger d-inline pull-right">
                                    <input type="radio" id="inactive" name="status" value="0" <?php echo e(old('status',$activity_category->status) == '0' ? 'checked' : ''); ?>>
                                    <label for="inactive">
                                        Inactive
                                    </label>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="image-upload">
                                    ...
                                    <div id="preview" style="background-image:url(<?php echo e(asset($activity_category->attachments->first()->file ?? '')); ?>)" class="image-preview"></div>
                                </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="<?php echo e(route('activity-category.index')); ?>" class="btn btn-danger bg-gradient-danger btn-sm float-right">Cancel</a>
                    </div>
                    <!-- /.card-footer -->
                </form>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PHP-8.2.4\htdocs\surjeralo\resources\views/backend/activity/category/edit.blade.php ENDPATH**/ ?>