...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('themes/frontend/assets/images/logo/favicon.png')); ?>" type="image/svg+xml">

    <link href="<?php echo e(asset('themes/frontend/assets/css/css/twentytwenty.css')); ?>" rel="stylesheet">
        ...
        <div class="main-nav-sub container">
            <div class="nav-logo-wrap position-static local-scroll">
                <div class="top__bar__logo">
                    <a href="<?php echo e(route('home')); ?>" class="logo d-flex align-items-center scrollto me-auto me-lg-0">
                        <img src="<?php echo e(asset('img/logo.png')); ?>" style="height:75px;width:120px;margin-top: -42px;">
                    </a>
                </div>
            </div>
            ...
            <div class="inner-nav desktop-nav">
                <ul class="clearlist local-scroll">
                    ...
                    <li>
                        <a href="<?php echo e(route('services')); ?>" class="mn-has-sub " id="sub-service">Services <i class="fas fa-chevron-down"></i></a>
                        ...
                        <div class="footer-info">
                            <div style="position: relative;width: 70%;" class="">
                                ...
                                <div class="small-logo">
                                    <img loading="lazy" src="<?php echo e(asset('img/logo.png')); ?>" alt="Colors Logo">
                                </div>
                            </div>
...
<script src="<?php echo e(asset('themes/frontend/assets/js/jquery.twentytwenty.js')); ?>"></script>
...
<?php /**PATH D:\laragon\www\photopixelqa\resources\views/layouts/front.blade.php ENDPATH**/ ?>