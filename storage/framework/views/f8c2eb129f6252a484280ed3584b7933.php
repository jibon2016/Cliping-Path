<?php $__env->startSection('title','At a Glance'); ?>
        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">At a Glance Information</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form id="company-information-form" enctype="multipart/form-data" action="<?php echo e(route('company-information.update',['company_information'=>$company_information->id])); ?>" class="form-horizontal" method="post">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="at_a_glance" class="col-sm-12">At a Glance <span class="text-danger">*</span></label>
                            <div class="col-sm-12">
                                <textarea name="at_a_glance" class="form-control" id="at_a_glance"><?php echo e(old('at_a_glance',$company_information->at_a_glance)); ?></textarea>
                                <span id="at_a_glance-error" class="text-danger error-message"></span>
                            </div>
                        </div>
                    </div>
                    <!-- /.card-body -->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PHP-8.2.4\htdocs\surjeralo\resources\views/backend/about_us/at_a_glance.blade.php ENDPATH**/ ?>