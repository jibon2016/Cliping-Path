...
@section('content')
    ...
    <section class="cart-list-area mt-20 mb-20">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('donation.pay') }}">
                        @csrf
                                ...
                                <div class="step-bg-clr">
                                    <div class="btn-list-wrap">
                                        @foreach($donationFunds as $donationFund)
                                            <input type="radio" id="{{ $donationFund->id }}" value="{{ $donationFund->id }}" name="donation_fund"
                                                   data-donation_fund_id="{{ $donationFund->id }}" class="select_fund">
                                            <label for="{{ $donationFund->id }}"
                                                   data-donation_fund="{{ $donationFund->name }}">{{ $donationFund->name }}</label>
                                        @endforeach
                                    </div>
