            ...
            <div class="card card-default">
                ...
                <form id="news-form" enctype="multipart/form-data" action="{{ route('service-details.update',['service'=>$service->id]) }}" class="form-horizontal" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input disabled type="text" value="{{ old('title',$service->title) }}" name="title" class="form-control" id="title" placeholder="Enter Title">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div id="file-previews" class="file-preview row">
                                    @if($service->serviceDetails != null)
                                        @foreach($service->serviceDetails->attachments as  $value)
                                            @php
                                                $attachment = $value;
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('service-details.index') }}" class="btn btn-danger bg-gradient-danger btn-sm float-right">Cancel</a>
                    </div>
                    <!-- /.card-footer -->
                </form>
            </div>
