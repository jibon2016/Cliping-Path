@extends('layouts.app')
@section('title','Success Story Edit')
@section('style')
    <!-- summernote -->
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form id="news-form" enctype="multipart/form-data" action="{{ route('story.update',['story'=>$story->id]) }}" class="form-horizontal" method="post">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" value="{{ old('title',$story->title) }}" name="title" class="form-control" id="title" placeholder="Enter Title">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <textarea name="short_description" class="form-control" id="short_description">{{ old('short_description',$story->short_description) }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <textarea name="description" id="description">{{ old('description',$story->description) }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <div class="icheck-success d-inline pull-right">
                                    <input  type="radio" id="active" name="status" value="1" {{ old('status',$story->status) == '1' ? 'checked' : '' }}>
                                    <label for="active">
                                        Active
                                    </label>
                                </div>
                                <div class="icheck-danger d-inline pull-right">
                                    <input type="radio" id="inactive" name="status" value="0" {{ old('status',$story->status) == '0' ? 'checked' : '' }}>
                                    <label for="inactive">
                                        Inactive
                                    </label>
                                </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('story.index') }}" class="btn btn-danger bg-gradient-danger btn-sm float-right">Cancel</a>
                    </div>
                    <!-- /.card-footer -->
                </form>
            </div>
