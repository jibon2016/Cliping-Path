@extends('layouts.app')
@section('title','Contact Us Information')
@section('style')
    <!-- summernote -->
        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Contact Us Information</h3>
                </div>
                <!-- /.card-header -->
                <form id="company-information-form" enctype="multipart/form-data" action="{{ route('company-information.update',['company_information'=>$company_information->id]) }}" class="form-horizontal" method="post">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="company_profile" class="col-sm-12">Contact Us <span class="text-danger">*</span></label>
                            <div class="col-sm-12">
                                <textarea name="contact_us" class="form-control" id="contact_us">{{ old('contact_us',$company_information->contact_us) }}</textarea>
                                <span id="contact_us-error" class="text-danger error-message"></span>
                            </div>
                        </div>
                    </div>
                    <!-- /.card-body -->
