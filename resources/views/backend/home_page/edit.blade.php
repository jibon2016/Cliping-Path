@extends('layouts.app')
@section('title','Home Page Video Edit')
@section('style')
    <style>
        .upload-container {
            text-align: center;
        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Home Page Video Information</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form id="news-form" enctype="multipart/form-data" action="{{ route('home-backend-video.update',['home_content'=>$homeContent->id]) }}" class="form-horizontal" method="post">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <div class="icheck-success d-inline pull-right">
                                    <input  type="radio" id="active" name="status" value="1" {{ old('status',$homeContent->status) == '1' ? 'checked' : '' }}>
                                    <label for="active">
                                        Active
                                    </label>
                                </div>
                                <div class="icheck-danger d-inline pull-right">
                                    <input type="radio" id="inactive" name="status" value="0" {{ old('status',$homeContent->status) == '0' ? 'checked' : '' }}>
                                    <label for="inactive">
                                        Inactive
                                    </label>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div id="file-previews" class="file-preview row">
                                    @foreach($homeContent->attachments as $attachment)
                                        <div class="wrapper-list-item">
                                            ...
                                            <video class="preview-video" controls>
                                                <source src="{{ asset($attachment->file) }}" type="video/mp4">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('home-backend.index') }}" class="btn btn-danger bg-gradient-danger btn-sm float-right">Cancel</a>
                    </div>
                    <!-- /.card-footer -->
                </form>
            </div>
