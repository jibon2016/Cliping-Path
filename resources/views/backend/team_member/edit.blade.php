    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form id="customer-form" enctype="multipart/form-data" action="{{ route('team-members.update',['team_member'=>$team_member->id]) }}" class="form-horizontal" method="post">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{ old('name',$team_member->name) }}" name="name" class="form-control" id="name" placeholder="Enter Name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{ old('designation',$team_member->designation) }}" name="designation" class="form-control" id="designation" placeholder="Enter Designation">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{ old('education',$team_member->education) }}" name="education" class="form-control" id="education" placeholder="Enter Education">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" value="{{ old('sort',$team_member->sort) }}" name="sort" class="form-control" id="sort" placeholder="Enter Sort">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="icheck-success d-inline pull-right">
                                    <input  type="radio" id="active" name="status" value="1" {{ old('status',$team_member->status) == '1' ? 'checked' : '' }}>
                                    <label for="active">
                                        Active
                                    </label>
                                </div>
                                <div class="icheck-danger d-inline pull-right">
                                    <input type="radio" id="inactive" name="status" value="0" {{ old('status',$team_member->status) == '0' ? 'checked' : '' }}>
                                    <label for="inactive">
                                        Inactive
                                    </label>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="image-upload">
                                    ...
                                    <div id="preview" style="background-image:url({{ asset($team_member->attachments->first()->file ?? '') }})" class="image-preview"></div>
                                </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('team-members.index') }}" class="btn btn-danger bg-gradient-danger btn-sm float-right">Cancel</a>
                    </div>
                    <!-- /.card-footer -->
                </form>
            </div>
