                ...
                <form id="company-information-form" enctype="multipart/form-data" action="{{ route('company-information.update',['company_information'=>$company_information->id]) }}" class="form-horizontal" method="post">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <textarea name="company_profile" class="form-control" id="company_profile">{{ old('company_profile',$company_information->company_profile) }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <textarea name="vision" class="form-control" id="vision">{{ old('vision',$company_information->vision) }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <textarea name="mission" class="form-control" id="mission">{{ old('mission',$company_information->mission) }}</textarea>
