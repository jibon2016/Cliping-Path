@extends('layouts.app')
@section('title','Activity Category Edit')
@section('style')
    <style>
        .image-upload {
            position: relative;
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form id="category-form" enctype="multipart/form-data" action="{{ route('activity-category.update',['activity_category'=>$activity_category->id]) }}" class="form-horizontal" method="post">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{ old('name',$activity_category->name) }}" name="name" class="form-control" id="name" placeholder="Enter Name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" value="{{ old('sort',$activity_category->sort) }}" name="sort" class="form-control" id="sort" placeholder="Enter Sort">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="icheck-success d-inline pull-right">
                                    <input  type="radio" id="active" name="status" value="1" {{ old('status',$activity_category->status) == '1' ? 'checked' : '' }}>
                                    <label for="active">
                                        Active
                                    </label>
                                </div>
                                <div class="icheck-danger d-inline pull-right">
                                    <input type="radio" id="inactive" name="status" value="0" {{ old('status',$activity_category->status) == '0' ? 'checked' : '' }}>
                                    <label for="inactive">
                                        Inactive
                                    </label>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="image-upload">
                                    ...
                                    <div id="preview" style="background-image:url({{ asset($activity_category->attachments->first()->file ?? '') }})" class="image-preview"></div>
                                </div>
