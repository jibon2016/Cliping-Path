    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form id="news-form" enctype="multipart/form-data" action="{{ route('service.update',['service'=>$service->id]) }}" class="form-horizontal" method="post">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="upload-container">
                                    ...
                                    <input type="file"  class="file-upload" name="attachments[]"
                                ...
                                <div id="file-previews" class="file-preview row">
                                    @if( $attachment = $service)
                                        @php
                                            $pathExtension = pathinfo($attachment->icon,PATHINFO_EXTENSION);
