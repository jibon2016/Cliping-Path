    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form enctype="multipart/form-data" id="service-form" action="{{ route('service.store') }}" class="form-horizontal" method="post">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Icon Attachment</label>
                            <div class="col-sm-10">
                                <div class="upload-container">
                                    <span class="flow-text" onclick="triggerFileInput()">Click or drag and drop attachments files here</span>
                                    <input type="file" class="file-upload" name="attachments[]" onchange="displayFilePreviews(this)">
                                </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('service.index') }}" class="btn btn-danger bg-gradient-danger btn-sm float-right">Cancel</a>
                    </div>
                    <!-- /.card-footer -->
                </form>
            </div>
